/*program to calculate the net salary of an
 ...
 //Author: Ashley Joy Akinyi
 //Reg no: CT101/G/20035/23
 //Date: 22/1/2025
 //version 1.0

 //importing java utility to scan for input that will be imput by employee or user
...
public class calculate_salary {
    ...
    public static void main(String[] args) {
        //A scanner called salary to collect input from the user
        ...
        //A scanner called years to collect the number of years the employee has worked 
